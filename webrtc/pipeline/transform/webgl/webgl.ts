 ...
 */
export class WebGLTransform implements FrameTransform { // eslint-disable-line no-unused-vars
    // All fields are initialized in init()
    canvas_ : OffscreenCanvas
    gl_ : WebGLRenderingContext
    sampler_ : WebGLUniformLocation
  ...
  async init() {
    ...
    const gl = (this.canvas_.getContext('webgl')) as WebGLRenderingContext;
